 ...
 *
 */
public class PeerBaseFailoverCallbackHandler extends PeerAbstractFailoverCallbackHandler{
    private Log        log = LogFactory.getLog(PeerBaseFailoverCallbackHandler.class);
