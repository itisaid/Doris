...
public interface RouteAlgorithm  {
	...
	public static final String _Route_algorithm_class = "route.algorithm.class";
	public static final String _Route_hashfunction_class = "route.hashfunction.class";
	...
	Integer getVirtualByKey(String key);
}
