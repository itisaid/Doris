 ...
 * @since 1.0 2011-6-16
 */
public class MockVirtualRouter implements VirtualRouter {
	  
	protected int virtualNum = 10;  //default.
	
	protected RouteAlgorithm algorithm;
	
	public MockVirtualRouter () {
		this( 10 );
	}
	
	public MockVirtualRouter(int virtualNum) {
