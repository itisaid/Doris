...
/**
 * ExpansionMigrationTask
 * 
 * @author Kun He (Raymond He), kun.hek@alibaba-inc.com
 * @since 1.0 2011-5-25
 */
public class ExpansionMigrationTask extends BaseMigrationTask {

    public ExpansionMigrationTask(MigrationManager migrationManager) {
        super("ExpansionMigrationTask", migrationManager);
    }
