...
public interface MigrationReporter {
	...
	void report(MigrationEvent event);
	
	void setMigrateReportService( MigrateReportService migrateReportService);
	
	MigrateReportService getMigrateReportService();
	
	void setPostMigrateReportService( PostMigrateReportService postMigrateReportService );
	
	PostMigrateReportService getPostMigrateReportService();
}
